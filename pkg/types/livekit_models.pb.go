...
type ParticipantInfo struct {
	...
	State    ParticipantInfo_State `protobuf:"varint,3,opt,name=state,proto3,enum=types.ParticipantInfo_State" json:"state,omitempty"`
...
type TrackInfo struct {
	...
	Sid   string    `protobuf:"bytes,1,opt,name=sid,proto3" json:"sid,omitempty"`
	Type  TrackType `protobuf:"varint,2,opt,name=type,proto3,enum=types.TrackType" json:"type,omitempty"`
	...
	// source of media
	Source TrackSource   `protobuf:"varint,9,opt,name=source,proto3,enum=types.TrackSource" json:"source,omitempty"`
...
type DataPacket struct {
	...
	Kind DataPacket_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=types.DataPacket_Kind" json:"kind,omitempty"`
...
type ClientInfo struct {
	...
	Sdk            ClientInfo_SDK `protobuf:"varint,1,opt,name=sdk,proto3,enum=types.ClientInfo_SDK" json:"sdk,omitempty"`
...
var file_livekit_models_proto_rawDesc = []byte{
	...
	0xef, 0x02, 0x0a, 0x04, 0x52, 0x6f, 0x6f, 0x6d, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x69, 0x64, 0x18,
	...
	0x69, 0x70, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65,
	0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e,
	0x67, 0x22, 0x38, 0x0a, 0x05, 0x43, 0x6f, 0x64, 0x65, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x69,
	0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6d, 0x69, 0x6d, 0x65, 0x12, 0x1b,
	0x0a, 0x09, 0x66, 0x6d, 0x74, 0x70, 0x5f, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x66, 0x6d, 0x74, 0x70, 0x4c, 0x69, 0x6e, 0x65, 0x22, 0xe2, 0x02, 0x0a, 0x0f,
	...
	0x6a, 0x6f, 0x69, 0x6e, 0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x69, 0x64, 0x64,
	0x65, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x68, 0x69, 0x64, 0x64, 0x65, 0x6e,
	0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x08, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04,
	...
	0x22, 0xe6, 0x02, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x10,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x69, 0x64, 0x22, 0x99, 0x01, 0x0a, 0x0a, 0x56, 0x69,
	0x64, 0x65, 0x6f, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x07, 0x71, 0x75, 0x61, 0x6c,
	...
	0x52, 0x07, 0x71, 0x75, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x77, 0x69, 0x64,
	...
	0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x69, 0x74, 0x72, 0x61,
	0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x62, 0x69, 0x74, 0x72, 0x61, 0x74,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x73, 0x72, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x04, 0x73, 0x73, 0x72, 0x63, 0x22, 0xc9, 0x01, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61, 0x50, 0x61,
	0x63, 0x6b, 0x65, 0x74, 0x12, 0x2c, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	,
	...
	0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x64, 0x65,
	0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x64, 0x73, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x69, 0x64, 0x73, 0x22, 0x5b, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x70, 0x61,
	...
	0x53, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x5f, 0x73, 0x69, 0x64,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x53, 0x69,
	0x64, 0x73, 0x22, 0xf0, 0x02, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66,
	...
	0x6f, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	...
	0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4d,
	0x6f, 0x64, 0x65, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x72, 0x18,
	...
	0x73, 0x22, 0x52, 0x0a, 0x03, 0x53, 0x44, 0x4b, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e,
	0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x06, 0x0a, 0x02, 0x4a, 0x53, 0x10, 0x01, 0x12, 0x09, 0x0a,
	0x05, 0x53, 0x57, 0x49, 0x46, 0x54, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x41, 0x4e, 0x44, 0x52,
	0x4f, 0x49, 0x44, 0x10, 0x03, 0x12, 0x0b, 0x0a, 0x07, 0x46, 0x4c, 0x55, 0x54, 0x54, 0x45, 0x52,
	0x10, 0x04, 0x12, 0x06, 0x0a, 0x02, 0x47, 0x4f, 0x10, 0x05, 0x12, 0x09, 0x0a, 0x05, 0x55, 0x4e,
	0x49, 0x54, 0x59, 0x10, 0x06, 0x2a, 0x2b, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x54, 0x79,
	...
	0x4e, 0x54, 0x10, 0x02, 0x42, 0x46, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_livekit_models_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_livekit_models_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_livekit_models_proto_goTypes = []interface{}{
	(TrackType)(0),              // 0: types.TrackType
	(TrackSource)(0),            // 1: types.TrackSource
	(VideoQuality)(0),           // 2: types.VideoQuality
	(ConnectionQuality)(0),      // 3: types.ConnectionQuality
	(ParticipantInfo_State)(0),  // 4: types.ParticipantInfo.State
	(DataPacket_Kind)(0),        // 5: types.DataPacket.Kind
	(ClientInfo_SDK)(0),         // 6: types.ClientInfo.SDK
	(*Room)(nil),                // 7: types.Room
	(*Codec)(nil),               // 8: types.Codec
	(*ParticipantInfo)(nil),     // 9: types.ParticipantInfo
	(*TrackInfo)(nil),           // 10: types.TrackInfo
	(*VideoLayer)(nil),          // 11: types.VideoLayer
	(*DataPacket)(nil),          // 12: types.DataPacket
	(*ActiveSpeakerUpdate)(nil), // 13: types.ActiveSpeakerUpdate
	(*SpeakerInfo)(nil),         // 14: types.SpeakerInfo
	(*UserPacket)(nil),          // 15: types.UserPacket
	(*ParticipantTracks)(nil),   // 16: types.ParticipantTracks
	(*ClientInfo)(nil),          // 17: types.ClientInfo
}
var file_livekit_models_proto_depIdxs = []int32{
	8,  // 0: types.Room.enabled_codecs:type_name -> types.Codec
	4,  // 1: types.ParticipantInfo.state:type_name -> types.ParticipantInfo.State
	10, // 2: types.ParticipantInfo.tracks:type_name -> types.TrackInfo
	0,  // 3: types.TrackInfo.type:type_name -> types.TrackType
	1,  // 4: types.TrackInfo.source:type_name -> types.TrackSource
	11, // 5: types.TrackInfo.layers:type_name -> types.VideoLayer
	2,  // 6: types.VideoLayer.quality:type_name -> types.VideoQuality
	5,  // 7: types.DataPacket.kind:type_name -> types.DataPacket.Kind
	15, // 8: types.DataPacket.user:type_name -> types.UserPacket
	13, // 9: types.DataPacket.speaker:type_name -> types.ActiveSpeakerUpdate
	14, // 10: types.ActiveSpeakerUpdate.speakers:type_name -> types.SpeakerInfo
	6,  // 11: types.ClientInfo.sdk:type_name -> types.ClientInfo.SDK
...
func file_livekit_models_proto_init() {
	...
	file_livekit_models_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*DataPacket_User)(nil),
