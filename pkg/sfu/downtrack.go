...
import (
	...
	"github.com/pion/ion-cluster/pkg/sfu/connectionquality"
)
...
type DownTrack struct {
	...
	// update stats
	onStatsUpdate func(dt *DownTrack, stat *types.AnalyticsStat)
...
func NewDownTrack(
	...
	d.connectionStats.OnStatsUpdate(func(_cs *connectionquality.ConnectionStats, stat *types.AnalyticsStat) {
...
func (d *DownTrack) PeerID() types.ParticipantID { return d.peerID }
...
func (d *DownTrack) OnStatsUpdate(fn func(dt *DownTrack, stat *types.AnalyticsStat)) {
	d.onStatsUpdate = fn
}
