...
type ConnectionStats struct {
	...
	onStatsUpdate func(cs *ConnectionStats, stat *types.AnalyticsStat)
...
func (cs *ConnectionStats) OnStatsUpdate(fn func(cs *ConnectionStats, stat *types.AnalyticsStat)) {
	cs.onStatsUpdate = fn
}
